...
while True:
  time.sleep(5)
  try:
    current_utilization = psutil.cpu_percent(interval=None)
    if(current_utilization > threshold):
      print('Alert! CPU usage exceeds threshold: ', str(current_utilization) + '%\n')
    # else:
    #   print('Current CPU utilization: ' + str(current_utilization) + '%\n')
  except psutil.Error:
    print('Error in getting information.')